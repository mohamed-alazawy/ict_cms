var table_room =  $('.table_room').DataTable({
		...
		buttons: [
			...
			},
			{
				...
				message: '<img src="LMS/assets/mycustom/js/logo.png" height="100px" width="100px" style="position: absolute;top:0;left:80px;"><center><h4 style="margin-top:-40px;">REPUBLIC OF THE IRAQ</h4>\
							<h5>INFORMATION TECHNOLOGY AND COMMUNICAIONS</h5>\
							<h6>BAGHDAD UNIVERSITY</h6>\
							</center>',
	...
	"ajax":
		...
		buttons: [
			...
			},
			{
				...
				message: '<img src="http://4.bp.blogspot.com/_5ydAHJv4lKc/TSm6Sr4vMWI/AAAAAAAAAAQ/B3oGPh3_26k/s1600/logo.png" height="100px" width="100px" style="position: absolute;top:0;left:80px;"><center><h4 style="margin-top:-40px;">REPUBLIC OF THE IRAQ</h4>\
							<h5>INFORMATION TECHNOLOGY AND COMMUNICAIONS</h5>\
							<h6>BAGHDAD UNIVERSITY</h6>\
							</center>',
				customize: function ( win ) {
							...
							dom: "Bfrtip",
									buttons: [
										...
										},
										{
											...
											message: '<center><h4>REPUBLIC OF THE IRAQ</h4>\
														<h5>INFORMATION TECHNOLOGY AND COMMUNICAIONS</h5>\
														<h6>BAGHDAD UNIVERSITY</h6>\
														</center>',
											customize: function ( win ) {
